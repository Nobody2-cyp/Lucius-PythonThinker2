...
# 1. Ask the user for a riddle and store their response in ‘user_input’ variable
# 2. Create an ‘is_correct’ variable with the Boolean value ‘False’
...
# 5. If ‘is_correct’ is ‘True’, print “Correct! Well done.”
...
# 4. Egg obviously
# is_correct = False
# user_input = input("what has to be broken before you can use it?").lower()
...
# try to make it into a loop that as long as it is not correct, it will keep asking
...
# windows = turtle.Screen()
# windows.screensize(width = 600, height = 600)
...
# 5. Define ‘draw_house’ function that uses the ‘draw_shape’ function to combine a square and a trianglewing a House
# You have been tasked to draw a house (made of a square and a triangle)
